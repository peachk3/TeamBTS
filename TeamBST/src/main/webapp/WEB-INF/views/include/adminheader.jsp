...
<nav>
			<c:choose>
				...
				<c:when test="${sessionScope.user_id == 'admin'}">
					...
					<form id="logoutForm" action="${pageContext.request.contextPath}/TeamBST/admin/admin" method="post" style="display: inline;">
...
<nav class="navbar main-nav border-less fixed-top navbar-expand-lg p-0">
  <div class="container-fluid p-0">
      <!-- logo -->
      <a class="navbar-brand" href="/TeamBST/admin/adminMember">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav mx-auto">
					<li class="nav-item"><a class="nav-link active" aria-current="page"
						href="/TeamBST/admin/adminSchedule">경기일정<span>/</span></a></li>
					<li class="nav-item"><a class="nav-link"
						href="/TeamBST/admin/adminMember">회원<span>/</span></a></li>
					<li class="nav-item"><a class="nav-link"
						href="/TeamBST/admin/adminNotice">고객센터</a></li>
				</ul>
				<c:choose>
					<c:when test="${empty sessionScope.user_id}">
						<!-- 로그인하지 않은 경우 -->
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu">
		       ...
		       <li> <a href="/TeamBST/admin/admin">Home</a></li>

...
<nav>
			<c:choose>
				...
				<c:when test="${sessionScope.user_id == 'admin'}">
					...
					<form id="logoutForm" action="/admin/admin" method="post" style="display: inline;">
				...
				<c:otherwise>
					...
					<form id="logoutForm" action="/login/generalLogout" method="post" style="display: inline;">
                    <button type="submit" class="logout-button">로그아웃</button>
                    </form>
				</c:otherwise>
			</c:choose>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
				...
				<c:choose>
					...
					<c:when test="${sessionScope.user_id == 'admin'}">
						...
						<form id="logoutForm" action="/login/adminLogout" method="post" style="display: inline;">

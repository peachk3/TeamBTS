     ...
     ${zone}
        <c:choose>
            <c:when test="${zone.zone_ty == 'A'}">
                <area target="_self" alt="A구역" data-value="${zone.zone_ty }" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('${zone.zone_ty }', '${zone.zone_id}') ">
            </c:when>
            <c:when test="${zone.zone_ty == 'B'}">
                <area target="_self" alt="B구역" data-value="${zone.zone_ty }" data-id="${zone.zone_id}"
            ...
            <c:when test="${zone.zone_ty == 'C'}">
                <area target="_self" alt="C구역" data-value="${zone.zone_ty }" data-id="${zone.zone_id}"
            ...
            <c:when test="${zone.zone_ty == 'D'}">
                <area target="_self" alt="D구역" data-value="${zone.zone_ty }" data-id="${zone.zone_id}"
            ...
            <c:when test="${zone.zone_ty == 'E'}">
                <area target="_self" alt="E구역" data-value="${zone.zone_ty }" data-id="${zone.zone_id}"

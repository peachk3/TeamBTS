...
<!-- 		<input type="hidden" id="zone" name="zone" value=""> -->
		...
		<map name="image-map">
			<area target="_self" alt="seatA" title="seatA" data-value="A"
			...
			<area target="_self" alt="seatB" title="seatB" data-value="B"
			...
			<area target="_self" alt="seatC" title="seatC" data-value="C"
			...
			<area target="_self" alt="seatD" title="seatD" data-value="D"
			...
			<area target="_self" alt="seatE" title="seatE" data-value="E"
...
<script type="text/javascript">
	function selectZone(zone_id){
		...
		window.location.href= "/ticketing/displaySeats/${stad_id}/game/${game_id}/zone/ " + zone_id;
	}
</script>

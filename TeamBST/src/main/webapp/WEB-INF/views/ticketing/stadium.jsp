     ...
     console.log('${zone}');
        <c:choose>
            <c:when test="${zone.zone_ty == 'A'}">
                <area target="_self" alt="A구역" data-value="A" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('A', '${zone.zone_id}') ">
            </c:when>
            <c:when test="${zone.zone_ty == 'B'}">
                <area target="_self" alt="B구역" data-value="B" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('B', '${zone.zone_id}')">
            </c:when>
            <c:when test="${zone.zone_ty == 'C'}">
                <area target="_self" alt="C구역" data-value="C" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('C', '${zone.zone_id}')">
            </c:when>
            <c:when test="${zone.zone_ty == 'D'}">
                <area target="_self" alt="D구역" data-value="D" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('D', '${zone.zone_id}')"> 
            </c:when>
            <c:when test="${zone.zone_ty == 'E'}">
                <area target="_self" alt="E구역" data-value="E" data-id="${zone.zone_id}"
                    ...
                    shape="poly" onclick="selectZone('E', '${zone.zone_id}')">
            </c:when>
        </c:choose>
    </c:forEach>
</map>

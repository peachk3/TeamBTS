...
<body>
   <nav>
	...
	<form id="zoneForm" action="seats/displaySeats" method="get">
		...
		<img src="../../resources/img/구장배치도.PNG" usemap="#image-map" alt="Stadium Map">

		<map name="image-map">
			<area target="_self" alt="seatA" title="seatA"
				href="displaySeats.jsp?zone_id=A"
			...
			<area target="_self" alt="seatB" title="seatB"
				href="displaySeats.jsp?zone_id=B"
			...
			<area target="_self" alt="seatC" title="seatC"
				href="displaySeats.jsp?zone_id=C"
			...
			<area target="_self" alt="seatD" title="seatD"
				href="displaySeats.jsp?zone_id=D"
			...
			<area target="_self" alt="seatE" title="seatE"
				href="displaySeats.jsp?zone_id=E"

						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active schedule-item" id="nov20">
								<button type="button" class="btn btn-main-md"
									onclick="location.href='/TeamBST/announcement/announcement'" style="width:125px;">공지사항</button>
								<button type="button" class="btn btn-main-md"
								...
								<table class="table table-bordered">
									...
									<tbody>
										<c:forEach var="dto" items="${nBoardList}">
											<tr>
												<td class="post"><a href="/TeamBST/announcement/announcementContent?notice_id=${dto.notice_id }">[공지]${dto.notice_sub}</a></td>
						...
						<nav class="d-flex justify-content-center">
						  <ul class="pagination">
						    ...
						    <c:if test="${pageDTO.prev}">
						      <li class="page-item">
						        <a class="page-link" href="/TeamBST/announcement/announcement?page=${pageDTO.startPage-1}" aria-label="prev">
						    ...
						    <c:forEach var="i" begin="${pageDTO.startPage}" end="${pageDTO.endPage}" step="1">
						      <li class="page-item ${pageDTO.cri.page == i ? 'active' : ''}">
						        <a class="page-link" href="/TeamBST/announcement/announcement?page=${i}">${i}</a>
						      </li>
						    </c:forEach>
						    ...
						    <c:if test="${pageDTO.next && pageDTO.endPage > 0}">
						      <li class="page-item">
						        <a class="page-link" href="/TeamBST/announcement/announcement?page=${pageDTO.endPage+1}" aria-label="Next">

...
<html lang="en">
  ...
  <body>
    ...
    <hr>
        ...
        <button type="button" class="community" onclick="location.href='announcement.html'">공지사항</button> <br>
        <button type="button" class="community" onclick="location.href='bulletin.html'">문의게시판</button>

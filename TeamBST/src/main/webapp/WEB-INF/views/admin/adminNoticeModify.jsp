...
<form action="/TeamBST/admin/adminNoticeModify?notice_id=${dto.notice_id }" method="post">
    ...
    <input type="button" onclick="location.href='/TeamBST/admin/adminNotice'" value="취소">

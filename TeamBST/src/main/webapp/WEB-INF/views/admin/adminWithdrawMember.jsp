						...
						<nav class="d-flex justify-content-center">
						  <ul class="pagination">
						    ...
						    <c:if test="${pageDTO.prev}">
						      <li class="page-item">
						        <a class="page-link" href="/TeamBST/admin/adminWithdrawMember?page=${pageDTO.startPage-1}" aria-label="prev">
						    ...
						    <c:forEach var="i" begin="${pageDTO.startPage}" end="${pageDTO.endPage}" step="1">
						      <li class="page-item ${pageDTO.cri.page == i ? 'active' : ''}">
						        <a class="page-link" href="/TeamBST/admin/adminWithdrawMember?page=${i}">${i}</a>
						      </li>
						    </c:forEach>
						    ...
						    <c:if test="${pageDTO.next && pageDTO.endPage > 0}">
						      <li class="page-item">
						        <a class="page-link" href="/TeamBST/admin/adminWithdrawMember?page=${pageDTO.endPage+1}" aria-label="Next">

...
<body>
    <nav>
      ...
      <button type="button" class="community" onclick="location.href='adminNotice.html'">공지사항</button> <br>
      <button type="button" class="community" onclick="location.href='adminBulletin.html'">문의 게시판</button> <br>




      <br><br><br><br><br><br><br>
      <button onclick="location.href='adminBulletinWrite.html'">글쓰기</button>
